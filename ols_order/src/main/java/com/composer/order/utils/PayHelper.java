package com.composer.order.utils;

import com.composer.order.config.PayConfig;

import com.composer.order.service.OrderService;
...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId) {
        ...
        try {
            ...
            //回调地址，付款成功后的接口
            data.put("notify_url", "http://test.ols.com/wxpay/notify");
            // 交易类型为扫码支付
