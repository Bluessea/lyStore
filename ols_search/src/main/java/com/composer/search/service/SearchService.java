package com.composer.search.service;

import com.composer.common.pojo.PageResult;
import com.composer.item.pojo.*;
import com.composer.search.client.BrandClient;
import com.composer.search.client.CategoryClient;
import com.composer.search.client.GoodsClient;
import com.composer.search.client.SpecificationClient;
import com.composer.search.pojo.Goods;
import com.composer.search.pojo.SearchRequest;
import com.composer.search.pojo.SearchResult;
import com.composer.search.repository.GoodsRepository;
...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        skus.forEach(sku -> {
            ...
            //获取sku中的图片，数据库的图片可能是多张，多张是以","分割，所以以逗号分割，返回图片数组，获取第一张图片
            map.put("image",StringUtils.isBlank(sku.getImages()) ? "" : StringUtils.split(sku.getImages(),",")[0]);
            skuMapList.add(map);
        });
        //根据spu的cid3查询出所有的搜索规格参数
